...
export class Migration1717255713995 implements MigrationInterface {
    name = 'Migration1717255713995'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`player\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`cpf\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`password\` int NOT NULL, \`deckId\` int NULL, UNIQUE INDEX \`REL_569cc8422548e3f94a22535b61\` (\`deckId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
